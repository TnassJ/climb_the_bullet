...
namespace Fungus
{
    ...
    public class DialogInput : MonoBehaviour
    {
        ...
        private GameInputs inputAction;
        ...
        protected virtual void Update()
        {
            ...
            //Debug.Log(currentStandaloneInputModule);
            if (writer != null)
            {
                ...
                //     SetNextLineFlag();
                // }
                if (inputAction.UI.Submit.WasPerformedThisFrame() || (cancelEnabled && inputAction.UI.Cancel.IsPressed()))
                {
                    SetNextLineFlag();
                }
            }
