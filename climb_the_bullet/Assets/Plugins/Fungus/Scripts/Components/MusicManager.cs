...
namespace Fungus
{
    ...
    public class MusicManager : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            //AudioSource[] audioSources = GameObject.Find("AudioSource(SE)").GetComponents<AudioSource>();
            audioSourceMusic = audioSources[0];
            audioSourceAmbiance = audioSources[1];
            audioSourceSoundEffect = audioSources[2];
            //audioSourceSoundEffect = GameObject.Find("AudioSource(SE)").GetComponent<AudioSource>();
